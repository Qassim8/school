...
const TeamSection = () => {
  ...
  return (
    <section className="py-24 bg-blue-50/50 relative overflow-hidden" id="team">
      {/* خلفية جمالية خفيفة */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="mb-20">
          ...
          <h2 className="text-3xl lg:text-5xl font-extrabold text-blue-900 mb-6">
        ...
        <div className="flex justify-center mb-16 relative">
          {/* خط ربط عمودي */}
          <div className="absolute top-full left-1/2 -translate-x-1/2 w-1 h-16 bg-blue-200"></div>

          <div className="bg-blue-900 text-white p-10 rounded-[2.5rem] shadow-2xl shadow-blue-200 w-full max-w-lg relative transform hover:-translate-y-2 transition-transform duration-300">
            <Award
            ...
            <h3 className="text-3xl font-black mb-2">أمال الكباشي</h3>
            <p className="text-blue-200 font-medium text-lg uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 relative">
          ...
          <div className="hidden md:block absolute -top-16 left-1/2 -translate-x-1/2 w-1 h-16 bg-blue-200 z-0"></div>

          {/* الإداري الأول (عزام خوجلي) */}
          <div className="bg-white p-8 rounded-3xl shadow-xl shadow-blue-100 border border-blue-50 relative group transition-all hover:border-blue-100 hover:shadow-2xl">
          ...
          {/* إداري ثاني (مثال) */}
          <div className="bg-white p-8 rounded-3xl shadow-xl shadow-blue-100 border border-blue-50 relative group transition-all hover:border-blue-100 hover:shadow-2xl md:-translate-y-6">
            <Briefcase className="w-12 h-12 text-blue-600 bg-blue-100 p-2.5 rounded-2xl mb-6 mx-auto" />
            <div className="w-20 h-20 bg-blue-50 rounded-full flex items-center justify-center mx-auto mb-5 border-2 border-blue-100">
        ...
        <div className="relative mt-24">
          {/* عنوان فرعي */}
          <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-blue-50 px-6 py-2 rounded-full border border-blue-100 flex items-center gap-2 text-blue-800 font-bold shadow-sm z-10">
            <Users size={20} />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-10">
            {teachers.map((teacher, index) => (
              <div
                key={index}
                className="bg-white/70 p-6 rounded-2xl border border-blue-100/50 hover:bg-white hover:shadow-lg transition-all group text-right"
              >
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 bg-blue-600 text-white rounded-xl flex items-center justify-center font-bold text-2xl shrink-0">
                    {teacher.initial}
                  </div>
                  <div>
                    <h5 className="font-bold text-blue-950 group-hover:text-blue-700 transition-colors">
                      {teacher.name}
                    </h5>
